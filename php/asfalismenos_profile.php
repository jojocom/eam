...
<div id="header_wrapper" class="wrapper">
    ...
    <!-- <div id="header"> -->
        ...
        <div id="breadcrump">
            <a href="index_profile.php">Αρχική Σελίδα</a> > <a href="asfalismenos_profile.php">Ασφαλισμένος</a>
        </div>
...
<div id="main_wrapper" class="wrapper">
    <h4>Υπηρεσίες για Ασφαλισμένους</h4>
    <table align="center">
        <tr>
            <td>• <a href="undercontruction.php">Υπολογισμός Ενσήμων</a></td>
            <td colspan="1">&nbsp;</td>
            <td>• <a href="futuresuntaksi.php">Υπολογισμός Ποσού Μελλοντικής Σύνταξης</a></td>
        </tr>
        <tr>
            <td colspan="3">&nbsp;</td>
        </tr>
        <tr>
            <td>• <a href="javascript:AlertIt();">Yποβολή Aιτήματος Συνταξιοδότησης</a></td>
                    ...
                    <?php
                        ...
                        if($rows == 1) {
                            ...
                            if ($type == 'Ασφαλισμένος') {
                                $query2 = "INSERT INTO `aitimata`(`username`, `type`) VALUES ('$username','Σύνταξης')";
        ...
        <tr>
            <td>• <a href="undercontruction.php">Ποσό Εισφορών από Εργοδότες</a></td>
            <td colspan="1">&nbsp;</td>
            <td colspan="1">&nbsp;</td>
        </tr>
    </table>
