...
<html>
<head>
<title>IKA - Ανακοινώσεις</title>

<link href="../css/announcements_style.css" rel="stylesheet" type="text/css" />
...
<div id="header_wrapper" class="wrapper">
        ...
        <div id="menu">
            ...
            <ul>
                ...
                <li><a href="announcements_profile.php" class="current">Ανακοινώσεις</a></li>
        ...
        <div id="breadcrump">
            <a href="index_profile.php">Αρχική Σελίδα</a> > <a href="announcements_profile.php">Ανακοινώσεις</a>
        </div>
...
<div id="main_wrapper" class="wrapper">
    <div id="choices">
        <ul>
            <li><a href="undercontruction.php">Νέα</a></li>
            <li><a href="undercontruction.php">Εγκλυκλιοι & <br> Έγγραφα</a></li>
            <li><a href="undercontruction.php">Δελτία Τύπου</a></li>
        </ul>
    </div>
    <div id="announcements" class="wrapper">
        <h4>Ανακοινώσεις</h4>
        <table align="center">
            <tr>
