...
<div id="header_wrapper" class="wrapper">
    ...
    <!-- <div id="header"> -->
        ...
        <div id="breadcrump">
            <a href="../index.php">Αρχική Σελίδα</a> > <a href="suntaxiouxos.php">Συνταξιούχος</a>
        </div>
...
<div id="main_wrapper" class="wrapper">
    ...
    <table align="center">
        <tr>
            <td>• <a href="login.php">Ατομικός Λογαριασμός Ασφάλισης</a></td>
            <td colspan="1">&nbsp;</td>
            <td>• <a href="login.php">Yποβολή Aιτήματος Aξιολόγησης Aναπηρίας</a></td>
        </tr>
        <tr>
            <td colspan="3">&nbsp;</td>
        </tr>
        <tr>
            <td>• <a href="login.php">Εκτύπωση Βεβαιώσεων</a></td>
            <td colspan="1">&nbsp;</td>
            <td>• <a href="login.php">Συνταξιούχοι Εξωτερικού</a></td>
        </tr>
        <tr>
            <td colspan="3">&nbsp;</td>
        </tr>
        <tr>
            <td>• <a href="login.php">Υπολογισμός Ποσού Σύνταξης</a></td>
            <td colspan="1">&nbsp;</td>
            <td colspan="1">&nbsp;</td>
        </tr>
    </table>
